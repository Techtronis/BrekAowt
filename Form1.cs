...
public partial class Form1 : Form
{
...

    {
        ...
        if (gameOver == false)
        {
            ...
            {
                if (x is PictureBox && x.Tag is not null && x.Tag.ToString() == "pictureBox" && gameOver == false)
                {
                ...
                else if (x is PictureBox && x.Tag is not null && x.Tag.ToString() == "pictureBox" && gameOver == true)
                {
                    this.Controls.Add(x);
                }
            }
    ...
    private void Reset()
    {
        ...
        {
            if (Controls[i].Tag is not null && Controls[i].Tag.ToString() == "pictureBox" && Controls[i] is PictureBox pb)
            {
                pb.Dispose();
                Controls.RemoveAt(i);
            }
